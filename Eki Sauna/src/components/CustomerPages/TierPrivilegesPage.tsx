      ...
      <div className="space-y-3.5">
        {TIER_BENEFITS.map((tier) => {
          ...
          return (
            <div 
              key={tier.tier}
              className={`p-4 rounded-3xl border bg-[#13131a] space-y-3 transition-all ${
                isCurrent 
                  ? 'border-amber-400 shadow-[0_0_25px_rgba(212,175,55,0.25)] bg-gradient-to-br from-[#201a10] to-[#110f0b]' 
