  ...
  return (
    <section className="relative z-20 min-h-[90vh] flex flex-col justify-center pt-32 pb-20">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden bg-deep-navy">
        ...
        >
          <source src="https://videos.pexels.com/video-files/2169880/2169880-uhd_3840_2160_30fps.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 lg:px-16 w-full mt-20 md:mt-10 flex flex-col items-center">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <h1 className={`text-6xl md:text-7xl lg:text-[5.5rem] ${playfair.className} text-white leading-[1.1] mb-6 animate-fade-in-up`} style={{ animationDelay: "100ms" }}>
          ...
          <p className="text-xl md:text-2xl text-white/90 font-light max-w-3xl mx-auto leading-relaxed tracking-wide animate-fade-in-up" style={{ animationDelay: "200ms" }}>
