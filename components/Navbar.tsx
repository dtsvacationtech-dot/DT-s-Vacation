  ...
  return (
    <>
      ...
      >
        ...
        <div className={`w-full pointer-events-auto transition-all duration-500 hidden md:block overflow-hidden ${isScrolled || isMobileMenuOpen ? "bg-deep-navy text-white h-9" : "border-b border-white/10 text-white/90 h-9"}`}>
          <div className="max-w-[1600px] h-full mx-auto px-5 md:px-8 lg:px-16 flex items-center justify-between text-[11px] font-bold tracking-widest uppercase">
            <div className="flex items-center gap-6 h-full">
              <span className="opacity-60 hidden lg:inline-block">DT&apos;s Vacation & Travel Ltd.</span>
              <a href="https://www.instagram.com/dtvacationandtravel" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-tropical-gold transition-colors">
              ...
              <a href="https://www.facebook.com/profile.php?id=61560585715323" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-tropical-gold transition-colors">
              ...
              <a href="https://wa.me/18768569812" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-tropical-gold transition-colors">
            ...
            <a href="https://wa.me/18768569812" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-tropical-gold transition-colors bg-white/10 px-4 h-full">
