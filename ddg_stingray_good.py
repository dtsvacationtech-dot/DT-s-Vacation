...
def search_ddg_images(query):
    ...
    bad_domains = ['alamy', 'alamy.com', 'shutterstock', 'istock', 'getty', 'stock', 'dreamstime', 'dissolve']
    ...
    for item in data.get('results', []):
        ...
        if url.endswith('.jpg') or url.endswith('.jpeg'):
            ...
            tmp = f"/tmp/{out}.jpg"
            img_req = urllib.request.Request(url, headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)'})
            try:
...
search_ddg_images("stingray city grand cayman site:caymanislands.ky OR site:tripadvisor.com OR site:sandals.com")
